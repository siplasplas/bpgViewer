...
void MainWindow::ShowImage(QString imgFile)
{
...
bool MainWindow::loadFile(const QString &cfileName)
{
    QString fileName;
    if (cfileName.endsWith(".bpg")) {
        bpgFile->openFile(cfileName);
        bpgFile->decodeBpg();
        fileName = QStandardPaths::
